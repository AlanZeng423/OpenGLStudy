...
/* An example of vertex shader in the shader language GLSL (OpenGL Shading Language):
#version 330 core
...
`gl_Position` assigns the position data
*/
...
int main()
{
    ...
    // ------------------------------------------------------------------
    float vertices[] = { //z值都为0，使得看上去是一个二维图形
        -0.5f, -0.5f, 0.0f, // left
     ...
     * Fifth argument步长: the space between consecutive vertex attributes
